...
# 	path('comment/<int:id>', views.comment, name='comment'),
    ...
    path('cash_to_bank_transfer/<int:id>/', views.cash_to_bank_transfer, name='cash_to_bank_transfer'),#new
    path('adjust_bank_balance/<int:id>/', views.adjust_bank_balance, name='adjust_bank_balance'),#new
    path('bank_to_bank_transfer/<int:id>/', views.bank_to_bank_transfer, name='bank_to_bank_transfer'),#new
    ...
    # path('namedes/', views.namedes, name='namedes'),#remove
    path('view_nameasc/<int:id>/', views.view_nameasc, name='view_nameasc'),
    # path('view_namedes/<int:id>/', views.view_namedes, name='view_namedes'),remove
